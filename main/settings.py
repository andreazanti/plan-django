...
SECRET_KEY = '6^ds6x3^lnzh2_$+46#tw0k#oo57h+7wdjd67_7!14np(^xmhh'
...
REST_FRAMEWORK = {
    ...
    # Here the  django authetnication classes
...
AUTHENTICATION_BACKENDS = (
    'users.auth.backends.AuthenticationBackend',  # Custom login
)
